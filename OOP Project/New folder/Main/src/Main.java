...
class Snake extends JFrame implements KeyListener, Runnable {
    ...
    JButton bonusfood;
    JTextArea t;
    int x = 500, y = 250, gu = 2, directionx = 1, directiony = 0, speed = 300, difference = 0, oldx, oldy, score = 0;
    int[] lbx = new int[300];
    int[] lby = new int[300];
    ...
    public void creatbar() {
        ...
        instruction.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(p2, "When game starts, play using arrow keys.\nEat more food to grow your snake and earn points.\nThank you for Playing this game.");
            }
        });
