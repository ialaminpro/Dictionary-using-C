...
/**
 * @author Al-Amin,Marjan,Riddhi, Parvez
 */
...
public class Snake extends JPanel {
    ...
    // Constants
    private final int SNAKE_RUNNING_SPEED_FAST = 350;    
    private final int SNAKE_RUNNING_SPEED_FASTER = 250;
    private final int SNAKE_RUNNING_SPEED_FASTEST = 150;
    private final int SNAKE_RUNNING_SPEED_FAST1 = 100;
    private final int SNAKE_RUNNING_SPEED_FAST2 = 50;
    private final int SNAKE_RUNNING_SPEED_FASTER1 = 25;
    private final int SNAKE_RUNNING_SPEED_FASTEST1 = 12;
    ...
    public void setJMenueBar(JFrame frame) {
        ...
        level4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                selectedSpeed = SNAKE_RUNNING_SPEED_FAST1;
                startNewGame();
            }
        });
        ...
        level5.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                selectedSpeed = SNAKE_RUNNING_SPEED_FAST2;
                startNewGame();
            }
        });
        ...
        level6.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                selectedSpeed = SNAKE_RUNNING_SPEED_FASTER1;
                startNewGame();
            }
        });
        ...
        level7.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                selectedSpeed = SNAKE_RUNNING_SPEED_FASTEST1;
                startNewGame();
            }
        });
        ...
        JMenu scores = new JMenu("High Scores");
        JMenuItem No_maze = new JMenuItem("No Maze");
        JMenuItem maze = new JMenuItem("Boader Maze");
        ...
        JMenuItem instruction = new JMenuItem("Instraction");
         instruction.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {                
                JOptionPane.showMessageDialog(null, "Use arrow keys to navigate the snake. Your main objective will be to 'eat' the food.\nEnjoy The game \n");
        ...
        creator.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {                
                JOptionPane.showMessageDialog(null, "Author: Snake Chermers\nVersion: 1.0.1 \n");
    ...
    public void createInitSnake() {
        ...
        for (int i = 0; i < totalBodyPart; i++) {
            ...
            snakeBodyPart[i].setBackground(Color.BLACK);
